...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('storage/favicon_site.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('storage/favicon_site.png') }}">
