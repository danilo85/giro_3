...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        <div class="flex flex-wrap gap-2">
            <a href="{{ route('notifications.index') }}" class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium hover:bg-blue-200 transition-colors">
                Notificações
            </a>
            <span class="bg-blue-600 text-white px-3 py-1 rounded-full text-sm font-medium">
                Preferências
            </span>
            <a href="#" class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium hover:bg-blue-200 transition-colors">
                Logs
            </a>
        </div>
    </div>
