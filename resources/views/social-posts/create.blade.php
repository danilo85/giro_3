...
@section('title', 'Novo Post - Redes Sociais')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
                <form action="{{ route('social-posts.store') }}" method="POST" enctype="multipart/form-data" id="socialPostForm">
                    @csrf
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mb-3">
                                <div class="flex items-center space-x-2 p-2 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                                    ...
                                    <button type="button" class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600" onclick="formatText('subscript')">
                                        <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M12 3a1 1 0 0 0 0 2h1.382l-4 12H8a1 1 0 0 0 0 2h4a1 1 0 0 0 0-2h-1.382l4-12H16a1 1 0 0 0 0-2h-4Zm4 14h2v1h-2v-1Z"/>
                                        </svg>
                                    </button>
                                </div>
                            </div>
                            <div id="legenda_editor" 
                                 ...
                                 oninput="syncEditorContent('legenda_editor', 'legenda')">{{ old('legenda') }}</div>
                            <input type="hidden" id="legenda" name="legenda" value="{{ old('legenda') }}">
                            <div class="flex justify-between items-center mt-2">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div id="carouselTextsInput_editor" 
                                 ...
                                 oninput="syncEditorContent('carouselTextsInput_editor', 'carousel_texts_combined'); updateCarouselPreview();"></div>
                            <input type="hidden" id="carousel_texts_combined" name="carousel_texts_combined" value="{{ old('carousel_texts_combined') }}">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex space-x-4">
                                <label class="flex items-center">
                                    <input type="radio" name="call_to_action_type" value="text" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" checked onchange="toggleCallToActionType()">
                                    <span class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Texto</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" name="call_to_action_type" value="image" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" onchange="toggleCallToActionType()">
                        ...
                        <!-- Texto Final -->
                        <div class="mb-6" id="text_call_to_action">
                            ...
                            <div id="texto_final_editor" 
                                 ...
                                 oninput="syncEditorContent('texto_final_editor', 'texto_final')">{{ old('texto_final') }}</div>
                            <input type="hidden" id="texto_final" name="texto_final" value="{{ old('texto_final') }}">
                            @error('texto_final')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6 hidden" id="image_call_to_action">
                    ...
                    <div class="px-6 py-4">
                        <div class="mb-4">
                            ...
                            <input type="date" 
                                   id="scheduled_date" 
                                   name="scheduled_date" 
                                   value="{{ old('scheduled_date', $scheduledDate) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="time" 
                                   id="scheduled_time" 
                                   name="scheduled_time" 
                                   value="{{ old('scheduled_time', $scheduledTime) }}"
