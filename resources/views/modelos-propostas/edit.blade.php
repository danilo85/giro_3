    ...
    <div class="mb-8">
        ...
        <div class="sm:hidden">
            <div class="flex flex-col space-y-4">
                <div class="w-full">
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Editar Modelo de Proposta</h1>
                    <p class="mt-1 text-gray-600 dark:text-gray-400">Atualize as informações do modelo "{{ $modeloProposta->nome }}"</p>
                </div>
