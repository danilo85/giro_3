...
<div class="max-w-7xl mx-auto px-4 py-6">
    ...
    <div class="mb-8">
        ...
        <div class="flex flex-col space-y-4 sm:hidden">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Editar Pagamento</h1>
                <p class="mt-1 text-gray-600 dark:text-gray-400">Atualize as informações do pagamento</p>
            </div>
