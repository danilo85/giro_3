...
@section('content')
<div class="min-h-screen bg-gray-50 dark:bg-gray-900" x-data="editRecipePage()">
    ...
    <div class="mb-6">
        ...
        <div class="flex flex-wrap gap-2 mb-4">
            ...
            <a href="{{ route('recipes.show', $recipe) }}" class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border border-gray-300 text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Editar Receita</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Edite as informações da receita "{{ $recipe->name }}"</p>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('recipes.show', $recipe) }}" 
                   ...
                   title="Voltar para visualizar receita">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="description" 
                                      ...
                                      placeholder="Descreva brevemente sua receita...">{{ old('description', $recipe->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div id="ingredients-container" class="space-y-3 relative">
                        <!-- Ingredientes existentes serão carregados via JavaScript -->
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div>
                        ...
                        <textarea id="preparation_method"
                                  ...
                                  required>{{ old('preparation_method', $recipe->preparation_method) }}</textarea>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Upload Area -->
                        <div id="upload-area" class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center hover:border-blue-500 dark:hover:border-blue-400 transition-colors cursor-pointer {{ $recipe->image_path ? 'hidden' : '' }}">
                            <input type="file" 
                                   id="image" 
                                   name="image" 
                                   accept="image/*"
                    ...
                    <div>
                        ...
                        <select id="recipe_category_id"
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}" {{ old('recipe_category_id', $recipe->category_id) == $category->id ? 'selected' : '' }}>
                                    {{ $category->name }}
                                </option>
                            @endforeach
                        </select>
...
function editRecipePage() {
    return {
        ingredientCount: 0,
        existingIngredients: @json($recipe->recipeIngredients->map(function($ri) {
            return [
        ...
        loadExistingIngredients() {
            ...
            this.existingIngredients.forEach((ingredient, index) => {
                this.addIngredientRow(ingredient.ingredient_name, ingredient.quantity, ingredient.unit);
            });
            
            // Se não há ingredientes, adicionar um vazio
